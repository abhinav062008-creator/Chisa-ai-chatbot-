// ========== CHISA AVATAR - FROM YOUR IMAGE ==========
// This WILL display on your website!
...
const AVATAR_STATES = {
    serene: {
        svg: `<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Long black hair - accurate from image -->
            ...
            <!-- Pale red eyes with white pupils - matches your image -->
            ...
            <!-- Beauty mark under right eye - EXACT from your image -->
            ...
            <!-- School uniform collar - black with red ribbon hint -->
            <path d="M78 142 L100 152 L122 142" fill="#2a1a3a" opacity="0.9"/>
            <circle cx="100" cy="148" r="4" fill="#ff4d4d" opacity="0.6"/>
            <!-- Hair details -->
...
// Add more emotions with the same style
...
console.log('🎨 AVATAR_STATES loaded with emotions:', Object.keys(AVATAR_STATES));
